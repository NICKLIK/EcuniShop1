...
namespace EcuniShop1.Controllers
{
    public class CatalogosController : Controller
    {
        ...
        public CatalogosController(EcuniShop1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCatalogo,Categoria,FiltroBusqueda,IdProducto")] Catalogo catalogo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCatalogo,Categoria,FiltroBusqueda,IdProducto")] Catalogo catalogo)
        {
