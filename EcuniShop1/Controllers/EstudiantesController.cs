...
namespace EcuniShop1.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(EcuniShop1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,NombreEstudiante,ApellidoEstudiante,Membresia,FechaNacimiento,IdUbicacion")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,NombreEstudiante,ApellidoEstudiante,Membresia,FechaNacimiento,IdUbicacion")] Estudiante estudiante)
        {
